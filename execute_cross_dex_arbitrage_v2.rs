...
async fn main() -> Result<()> {
    ...
    loop {
        ...
        if spread_percent > 5.0 && profit_per_sol > 1.0 {
            ...
            info!("🛒 PASO 1: [SIMULADO] Comprando SOL en Orca a ${:.2}...", orca_sol_price);
        ...
        if cycle_count % 10 == 0 {
            ...
            info!("💰 Balance inicial: {} SOL", initial_balance as f64 / 1_000_000_000.0);
            info!("💰 Balance actual: {} SOL", current_balance as f64 / 1_000_000_000.0);
            info!("📈 Cambio total: {:.6} SOL", total_change as f64 / 1_000_000_000.0);
        }
