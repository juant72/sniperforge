                    ...
                    for jupiter_opp in jupiter_opportunities {
                        ...
                        let direct_opp = DirectOpportunity {
                            pool_a: PoolData {
                                ...
                                token_a_vault: jupiter_opp.input_token,
                                token_b_vault: jupiter_opp.output_token,
                                fee_rate: jupiter_opp.slippage_bps as u64,
                                tvl_usd: 0.0,
                                volume_24h_usd: 0.0,
                                is_active: true,
                            ...
                            pool_b: PoolData {
                                ...
                                token_a_vault: jupiter_opp.output_token,
                                token_b_vault: jupiter_opp.input_token,
                                fee_rate: jupiter_opp.slippage_bps as u64,
                                tvl_usd: 0.0,
                                volume_24h_usd: 0.0,
                                is_active: true,
