...
async fn main() -> Result<()> {
    ...
    info!("🔗 Explorer: https://explorer.solana.com/tx/{}?cluster=devnet", transfer_signature_1);
    ...
    info!("🔗 Explorer: https://explorer.solana.com/tx/{}?cluster=devnet", transfer_signature_2);
    ...
    info!("💰 Cambio neto:      {:.9} SOL", net_change as f64 / 1_000_000_000.0);
...
async fn execute_real_transfer(
    ...
    info!("   📤 Ejecutando transferencia real: {} lamports", amount_lamports);
    info!("   📝 Memo: {}", memo);
