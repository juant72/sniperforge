...
pub async fn run_cli() -> Result<()> {
    let matches = Command::new("SniperForge CLI")
        ...
        .subcommand(
            Command::new("arbitrage-bot")
                .about("[BOT] Start autonomous arbitrage bot for live trading")
                .arg(Arg::new("capital")
                    .short('c')
                    .long("capital")
                    .value_name("USD")
                    .help("Initial capital for arbitrage trading (default: 1000.0)")
                ...
                .arg(
                    Arg::new("network")
                        .long("network")
                        .value_name("NET")
                        .help("Network for arbitrage bot: devnet or mainnet")
                        .required(true)
                        .value_parser(["devnet", "mainnet"])
                )
        )
