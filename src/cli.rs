    ...
    let matches = Command::new("SniperForge CLI")
        ...
        .subcommand(
            Command::new("performance")
                .about("🚀 SPRINT 2: Performance optimization tools")
                .after_help("Sprint 2 performance monitoring, benchmarking, and optimization tools")
                .subcommand(
                    Command::new("benchmark")
                        .about("Run performance benchmark suite")
                        .after_help("Execute comprehensive performance benchmarks to measure current system performance against Sprint 2 targets")
                        .arg(Arg::new("output")
                            .short('o')
                            .long("output")
                            .value_name("FILE")
                            .help("Output file for benchmark results (default: sprint2_benchmark_results.json)")
                            .default_value("sprint2_benchmark_results.json"))
                ...
                .subcommand(
                    Command::new("profile")
                        .about("Start real-time performance profiling")
                        .after_help("Start system profiling to monitor performance metrics in real-time")
                        .arg(Arg::new("duration")
                            .short('d')
                            .long("duration")
                            .value_name("SECONDS")
                        ...
                        .arg(Arg::new("output")
                            ...
                            .long("output")
                            .value_name("FILE")
                            .help("Output file for profile data (default: sprint2_profile.json)")
                            .default_value("sprint2_profile.json"))
                )
                .subcommand(
                    Command::new("metrics")
                        .about("Show current performance metrics")
                        .after_help("Display current performance metrics and Sprint 2 target analysis")
                )
                .subcommand(
                    Command::new("optimize")
                        .about("Run automated performance optimization")
                        .after_help("Execute automated optimization routines based on current performance analysis")
                        .arg(Arg::new("target")
                            .short('t')
                            .long("target")
                            .value_name("METRIC")
                            .help("Specific metric to optimize: latency, memory, throughput, cpu")
                        )
                )
        )
        .get_matches();
